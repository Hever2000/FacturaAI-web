...
export function Demo() {
  ...
  const { hasReachedLimit, incrementUsage } = useDemoLimit(isAuthenticated);
  ...
  const processFile = useCallback(async (file: File) => {
    ...
    try {
      ...
      const response = await jobsApi.process(file, () => {});
  ...
  const pollJobStatus = useCallback(
    ...
    [isAuthenticated, incrementUsage]
  );
        ...
        <div className="mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <span className="px-3 py-1 text-xs font-medium bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400 rounded-full">
                Modo demo
              </span>
            </div>
          ...
          <div className="max-w-md mx-auto text-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">Alcanzaste el límite del demo</h3>
            <p className="text-muted-foreground mb-6">
              Registrate gratis para seguir usando FacturaAI y procesar todas las facturas que
              necesites.
            </p>
              ...
              <>
                ...
                {!isAuthenticated && (
                  <Card className="border-amber-500/50 bg-amber-500/10">
                    <CardContent className="pt-6">
                      <div className="text-center">
                        <h4 className="font-semibold mb-2">¿Querés procesar más facturas?</h4>
                        <p className="text-sm text-muted-foreground mb-4">
                          Creá una cuenta gratis y tené acceso ilimitado
                        </p>
