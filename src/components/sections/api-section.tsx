    ...
    <section id="api" className="py-24 px-6 relative">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl">API REST</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Endpoint: POST /v1/process</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {(['curl', 'javascript', 'python'] as const).map((lang) => (
                  <button
                    ...
                    className={cn(
                      ...
                      activeTab === lang ? 'bg-teal-500 text-white' : 'bg-muted hover:bg-muted/80'
                    )}
                  >
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Estado: 200 OK</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="relative">
                <pre className="rounded-lg bg-[#0d1117] p-4 overflow-x-auto text-sm max-h-[400px] overflow-y-auto">
                  <code className="text-gray-300">{JSON.stringify(responseExample, null, 2)}</code>
                </pre>
                <Button
                  variant="ghost"
                  size="sm"
